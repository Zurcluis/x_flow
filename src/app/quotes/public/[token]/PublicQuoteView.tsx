...
export function PublicQuoteView({ quote: initialQuote, token }: { quote: Quote | null; token: string }) {
  ...
  const handleConfirmApproval = (e: React.FormEvent) => {
    ...
    void approvePublicQuoteAction(token ?? "", selectedOptionId, approverName).catch((err) =>
      console.error("Falha ao aprovar publicamente:", err)
    );
  };
